        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Socials_SocialTypes_SocialTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sinpe = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Phone = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Entrepeneurships", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Entrepeneurships_Districts_DistrictId",
            ...
            migrationBuilder.CreateTable(
                name: "EntrepeneurshipSocials",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EntrepeneurshipId = table.Column<int>(type: "int", nullable: false),
                    SocialId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EntrepeneurshipSocials", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EntrepeneurshipSocials_Entrepeneurships_EntrepeneurshipId",
                        column: x => x.EntrepeneurshipId,
                        principalTable: "Entrepeneurships",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EntrepeneurshipSocials_Socials_SocialId",
                        column: x => x.SocialId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EntrepeneurshipAdmins", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EntrepeneurshipAdmins_Entrepeneurships_EntrepeneurshipId",
                        column: x => x.EntrepeneurshipId,
                        principalTable: "Entrepeneurships",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EntrepeneurshipAdmins_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkShopClients", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkShopClients_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkShopClients_Workshops_WorkshopId",
                        column: x => x.WorkshopId,
                        principalTable: "Workshops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderProducts_Inventories_InventoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EntrepeneurshipAdmins_EntrepeneurshipId",
                table: "EntrepeneurshipAdmins",
                column: "EntrepeneurshipId");

            migrationBuilder.CreateIndex(
                name: "IX_EntrepeneurshipAdmins_UserId",
                table: "EntrepeneurshipAdmins",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Entrepeneurships_DistrictId",
                table: "Entrepeneurships",
                column: "DistrictId");

            migrationBuilder.CreateIndex(
                name: "IX_EntrepeneurshipSocials_EntrepeneurshipId",
                table: "EntrepeneurshipSocials",
                column: "EntrepeneurshipId");

            migrationBuilder.CreateIndex(
                name: "IX_EntrepeneurshipSocials_SocialId",
                table: "EntrepeneurshipSocials",
                column: "SocialId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_EntrepeneurshipId",
                table: "Orders",
                column: "EntrepeneurshipId");

            migrationBuilder.CreateIndex(
                name: "IX_Socials_SocialTypeId",
                table: "Socials",
                column: "SocialTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkShopClients_UserId",
                table: "WorkShopClients",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkShopClients_WorkshopId",
                table: "WorkShopClients",
                column: "WorkshopId");
